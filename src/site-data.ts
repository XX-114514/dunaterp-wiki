...
export const pages: Record<string, WikiPage> = {
  ...
  "responsible-ai": {
    ...
    sections: [
      ...
      { title: "English Dry Lab pages", body: "On 10 September 2026, OpenAI Codex assisted with English translation of the team-authored transcriptomics and mathematical modeling manuscript and with page implementation. Existing numerical tables and scientific figures were transferred from that manuscript; no new scientific analysis or figure generation was performed for this website revision. Human review of the translation is pending." },
